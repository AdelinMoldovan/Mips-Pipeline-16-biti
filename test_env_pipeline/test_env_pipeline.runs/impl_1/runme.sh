...
HD_PWD='C:/Users/ASUS/Desktop/Facultate/an2/semestru2/AC/test_env_pipeline/test_env_pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_env_pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_env_pipeline.tcl -notrace
