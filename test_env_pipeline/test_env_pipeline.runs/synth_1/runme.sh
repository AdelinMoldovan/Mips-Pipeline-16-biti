...
HD_PWD='C:/Users/ASUS/Desktop/Facultate/an2/semestru2/AC/test_env_pipeline/test_env_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_env_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_env_pipeline.tcl
